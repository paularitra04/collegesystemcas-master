    ...
    <div class="header-right">
        ...
        <div style="position: relative;">
            <div id="profileBtn" onclick="toggleProfileMenu()" 
                ...
                <img src="https://ui-avatars.com/api/?name=<%= currentTeacher != null ? currentTeacher.getName() : "Teacher" %>&background=7b2cbf&color=fff&bold=true" 
                ...
                <div class="d-none d-md-block" style="pointer-events: none;">
                    <div style="font-weight: 700; font-size: 14px; line-height: 1.2;"><%= currentTeacher != null ? currentTeacher.getName() : "Teacher" %></div>
                    <div style="font-size: 12px; color: #6c757d;">Teacher</div>
                </div>
            ...
            <div id="profileMenu" style="display: none; position: absolute; right: 0; top: calc(100% + 8px); background: white; border-radius: 12px; box-shadow: 0 10px 40px rgba(0,0,0,0.15); min-width: 220px; z-index: 99999; overflow: hidden;">
                <div style="padding: 15px 18px; border-bottom: 1px solid #f0f0f0;">
                    <div style="font-weight: 700; font-size: 15px;"><%= currentTeacher != null ? currentTeacher.getName() : "Teacher" %></div>
                    <div style="font-size: 13px; color: #6c757d;">Teacher</div>
                </div>
                <a href="#" style="display: flex; align-items: center; gap: 10px; padding: 12px 18px; text-decoration: none; color: #333; transition: background 0.15s;" 
